...
<legend id="legendMe">답글달기</legend>
	<form action="reWritePro.jsp" method="post" name="fr" id="formMe">
		<div id="centerMe">
			...
			<input type="text" name="subject" maxlength="15" class="inputMe" value="[답글] " required ><br>
			<input type="text" class="lableMe" value="내용 " style="margin-right: 460px;" readonly/><br>
			<textarea rows="10" cols="35" name="content" class="inputMe" placeholder="여기에  답글을 작성해주세요" style="width: 572px;" required></textarea><br>
		</div>
		<input type="submit" value="답글 등록" class="btnn">
