...
import com.ecodeda.reImg.DBCPConn;
import com.ecodeda.reImg.FileManager;
import com.ecodeda.reImg.MyUtil;
import com.ecodeda.reImg.imageDAO;
import com.ecodeda.reImg.imageDTO;
...
public class ImageServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		if (uri.indexOf("write.do") != -1) {
			...
			List<imageDTO> lists = dao.getList(start, end);
